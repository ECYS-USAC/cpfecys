...
def grades_management_export():
    ...
    for assigantion in assigantions:
        ...
        if session.search_grades_management == "" or session.search_grades_management is None:
            ...
            tempRemport1.append(str(db((db.grades_log.project==assigantion.project.name)&(db.grades_log.yearp==str(year.yearp))&(db.grades_log.period==str(T(year.period.name)))&(db.grades_log.operation_log=='insert')&(db.grades_log.academic==str(session.search_grades_management))).count(db.grades_log.id)))
            tempRemport1.append(str(db((db.grades_log.project==assigantion.project.name)&(db.grades_log.yearp==str(year.yearp))&(db.grades_log.period==str(T(year.period.name)))&(db.grades_log.operation_log=='update')&(db.grades_log.academic==str(session.search_grades_management))).count(db.grades_log.id)))
            tempRemport1.append(str(db((db.grades_log.project==assigantion.project.name)&(db.grades_log.yearp==str(year.yearp))&(db.grades_log.period==str(T(year.period.name)))&(db.grades_log.operation_log=='delete')&(db.grades_log.academic==str(session.search_grades_management))).count(db.grades_log.id)))
        pass
        report.append(tempRemport1)
        ...
        for month in vecMonth:
            ...
            if session.search_grades_management == "" or session.search_grades_management is None:
                ...
                tempRemport2.append(str(db((db.grades_log.project==assigantion.project.name)&(db.grades_log.yearp==str(year.yearp))&(db.grades_log.period==str(T(year.period.name)))&(db.grades_log.operation_log=='insert')&(db.grades_log.date_log>=str(start))&(db.grades_log.date_log<str(end))&(db.grades_log.academic==str(session.search_grades_management))).count(db.grades_log.id)))
                tempRemport2.append(str(db((db.grades_log.project==assigantion.project.name)&(db.grades_log.yearp==str(year.yearp))&(db.grades_log.period==str(T(year.period.name)))&(db.grades_log.operation_log=='update')&(db.grades_log.date_log>=str(start))&(db.grades_log.date_log<str(end))&(db.grades_log.academic==str(session.search_grades_management))).count(db.grades_log.id)))
                tempRemport2.append(str(db((db.grades_log.project==assigantion.project.name)&(db.grades_log.yearp==str(year.yearp))&(db.grades_log.period==str(T(year.period.name)))&(db.grades_log.operation_log=='delete')&(db.grades_log.date_log>=str(start))&(db.grades_log.date_log<str(end))&(db.grades_log.academic==str(session.search_grades_management))).count(db.grades_log.id)))
            pass
            report.append(tempRemport2)
            ...
            for roll in tempRole:
                ...
                if session.search_grades_management == "" or session.search_grades_management is None:
                    ...
                    tempRemport3.append(str(db((db.grades_log.project==assigantion.project.name)&(db.grades_log.yearp==str(year.yearp))&(db.grades_log.period==str(T(year.period.name)))&(db.grades_log.operation_log=='insert')&(db.grades_log.date_log>=str(start))&(db.grades_log.date_log<str(end))&(db.grades_log.roll==roll)&(db.grades_log.academic==str(session.search_grades_management))).count(db.grades_log.id)))
                    tempRemport3.append(str(db((db.grades_log.project==assigantion.project.name)&(db.grades_log.yearp==str(year.yearp))&(db.grades_log.period==str(T(year.period.name)))&(db.grades_log.operation_log=='update')&(db.grades_log.date_log>=str(start))&(db.grades_log.date_log<str(end))&(db.grades_log.roll==roll)&(db.grades_log.academic==str(session.search_grades_management))).count(db.grades_log.id)))
                    tempRemport3.append(str(db((db.grades_log.project==assigantion.project.name)&(db.grades_log.yearp==str(year.yearp))&(db.grades_log.period==str(T(year.period.name)))&(db.grades_log.operation_log=='delete')&(db.grades_log.date_log>=str(start))&(db.grades_log.date_log<str(end))&(db.grades_log.roll==roll)&(db.grades_log.academic==str(session.search_grades_management))).count(db.grades_log.id)))
                pass
                report.append(tempRemport3)
                ...
                for userr in tempUsers:
                    ...
                    if session.search_grades_management == "" or session.search_grades_management is None:
                        ...
                        tempRemport4.append(str(db((db.grades_log.project==assigantion.project.name)&(db.grades_log.yearp==str(year.yearp))&(db.grades_log.period==str(T(year.period.name)))&(db.grades_log.operation_log=='insert')&(db.grades_log.date_log>=str(start))&(db.grades_log.date_log<str(end))&(db.grades_log.roll==roll)&(db.grades_log.user_name==userr)&(db.grades_log.academic==str(session.search_grades_management))).count(db.grades_log.id)))
                        tempRemport4.append(str(db((db.grades_log.project==assigantion.project.name)&(db.grades_log.yearp==str(year.yearp))&(db.grades_log.period==str(T(year.period.name)))&(db.grades_log.operation_log=='update')&(db.grades_log.date_log>=str(start))&(db.grades_log.date_log<str(end))&(db.grades_log.roll==roll)&(db.grades_log.user_name==userr)&(db.grades_log.academic==str(session.search_grades_management))).count(db.grades_log.id)))
                        tempRemport4.append(str(db((db.grades_log.project==assigantion.project.name)&(db.grades_log.yearp==str(year.yearp))&(db.grades_log.period==str(T(year.period.name)))&(db.grades_log.operation_log=='delete')&(db.grades_log.date_log>=str(start))&(db.grades_log.date_log<str(end))&(db.grades_log.roll==roll)&(db.grades_log.user_name==userr)&(db.grades_log.academic==str(session.search_grades_management))).count(db.grades_log.id)))
                    pass
                    report.append(tempRemport4)
    ...
    if createReport==True:
        ...
        #LEVEL 2
            ...
            for month in vecMonth:
                ...
                if session.search_grades_management == "" or session.search_grades_management is None:
                    ...
                    tempRemport1.append(str(db((db.grades_log.project==level_project.name)&(db.grades_log.yearp==str(year.yearp))&(db.grades_log.period==str(T(year.period.name)))&(db.grades_log.date_log>=str(start))&(db.grades_log.date_log<str(end))&(db.grades_log.operation_log=='insert')&(db.grades_log.academic==str(session.search_grades_management))).count(db.grades_log.id)))
                    tempRemport1.append(str(db((db.grades_log.project==level_project.name)&(db.grades_log.yearp==str(year.yearp))&(db.grades_log.period==str(T(year.period.name)))&(db.grades_log.date_log>=str(start))&(db.grades_log.date_log<str(end))&(db.grades_log.operation_log=='update')&(db.grades_log.academic==str(session.search_grades_management))).count(db.grades_log.id)))
                    tempRemport1.append(str(db((db.grades_log.project==level_project.name)&(db.grades_log.yearp==str(year.yearp))&(db.grades_log.period==str(T(year.period.name)))&(db.grades_log.date_log>=str(start))&(db.grades_log.date_log<str(end))&(db.grades_log.operation_log=='delete')&(db.grades_log.academic==str(session.search_grades_management))).count(db.grades_log.id)))
                pass
                report.append(tempRemport1)
        ...
        #LEVEL 3
            ...
            for roll in tempRole:
                ...
                if session.search_grades_management == "" or session.search_grades_management is None:
                    ...
                    if ((level_tipo=='all') or (level_tipo=='i')):
                        tempRemport1.append(str(db((db.grades_log.project==level_project.name)&(db.grades_log.yearp==str(year.yearp))&(db.grades_log.period==str(T(year.period.name)))&(db.grades_log.date_log>=str(start))&(db.grades_log.date_log<str(end))&(db.grades_log.operation_log=='insert')&(db.grades_log.roll==roll)&(db.grades_log.academic==str(session.search_grades_management))).count(db.grades_log.id)))
                    if ((level_tipo=='all') or (level_tipo=='u')):
                        tempRemport1.append(str(db((db.grades_log.project==level_project.name)&(db.grades_log.yearp==str(year.yearp))&(db.grades_log.period==str(T(year.period.name)))&(db.grades_log.date_log>=str(start))&(db.grades_log.date_log<str(end))&(db.grades_log.operation_log=='update')&(db.grades_log.roll==roll)&(db.grades_log.academic==str(session.search_grades_management))).count(db.grades_log.id)))
                    if ((level_tipo=='all') or (level_tipo=='d')):
                        tempRemport1.append(str(db((db.grades_log.project==level_project.name)&(db.grades_log.yearp==str(year.yearp))&(db.grades_log.period==str(T(year.period.name)))&(db.grades_log.date_log>=str(start))&(db.grades_log.date_log<str(end))&(db.grades_log.operation_log=='delete')&(db.grades_log.roll==roll)&(db.grades_log.academic==str(session.search_grades_management))).count(db.grades_log.id)))
                pass
                report.append(tempRemport1)
        ...
        #LEVEL 4
            ...
            for userr in tempUsers:
                ...
                if session.search_grades_management == "" or session.search_grades_management is None:
                    ...
                    if ((level_tipo=='all') or (level_tipo=='i')):
                        tempRemport1.append(str(db((db.grades_log.project==level_project.name)&(db.grades_log.yearp==str(year.yearp))&(db.grades_log.period==str(T(year.period.name)))&(db.grades_log.date_log>=str(start))&(db.grades_log.date_log<str(end))&(db.grades_log.operation_log=='insert')&(db.grades_log.roll==level_rol)&(db.grades_log.user_name==userr)&(db.grades_log.academic==str(session.search_grades_management))).count(db.grades_log.id)))
                    if ((level_tipo=='all') or (level_tipo=='u')):
                        tempRemport1.append(str(db((db.grades_log.project==level_project.name)&(db.grades_log.yearp==str(year.yearp))&(db.grades_log.period==str(T(year.period.name)))&(db.grades_log.date_log>=str(start))&(db.grades_log.date_log<str(end))&(db.grades_log.operation_log=='update')&(db.grades_log.roll==level_rol)&(db.grades_log.user_name==userr)&(db.grades_log.academic==str(session.search_grades_management))).count(db.grades_log.id)))
                    if ((level_tipo=='all') or (level_tipo=='d')):
                        tempRemport1.append(str(db((db.grades_log.project==level_project.name)&(db.grades_log.yearp==str(year.yearp))&(db.grades_log.period==str(T(year.period.name)))&(db.grades_log.date_log>=str(start))&(db.grades_log.date_log<str(end))&(db.grades_log.operation_log=='delete')&(db.grades_log.roll==level_rol)&(db.grades_log.user_name==userr)&(db.grades_log.academic==str(session.search_grades_management))).count(db.grades_log.id)))
                pass
                report.append(tempRemport1)
        ...
        #LEVEL 5
            ...
            if session.search_grades_management == "" or session.search_grades_management is None:
                ...
                if ((level_tipo=='all') or (level_tipo=='i')):
                    temp_vecAllUserRoleMonth.append(db((db.grades_log.project==level_project.name)&(db.grades_log.yearp==str(year.yearp))&(db.grades_log.period==str(T(year.period.name)))&(db.grades_log.date_log>=str(start))&(db.grades_log.date_log<str(end))&(db.grades_log.operation_log=='insert')&(db.grades_log.roll==level_rol)&(db.grades_log.user_name==level_user)&(db.grades_log.academic==str(session.search_grades_management))).select())
                if ((level_tipo=='all') or (level_tipo=='u')):
                    temp_vecAllUserRoleMonth.append(db((db.grades_log.project==level_project.name)&(db.grades_log.yearp==str(year.yearp))&(db.grades_log.period==str(T(year.period.name)))&(db.grades_log.date_log>=str(start))&(db.grades_log.date_log<str(end))&(db.grades_log.operation_log=='update')&(db.grades_log.roll==level_rol)&(db.grades_log.user_name==level_user)&(db.grades_log.academic==str(session.search_grades_management))).select())
                if ((level_tipo=='all') or (level_tipo=='d')):
                    temp_vecAllUserRoleMonth.append(db((db.grades_log.project==level_project.name)&(db.grades_log.yearp==str(year.yearp))&(db.grades_log.period==str(T(year.period.name)))&(db.grades_log.date_log>=str(start))&(db.grades_log.date_log<str(end))&(db.grades_log.operation_log=='delete')&(db.grades_log.roll==level_rol)&(db.grades_log.user_name==level_user)&(db.grades_log.academic==str(session.search_grades_management))).select())
            pass
            varTypeHead=0
            for field in temp_vecAllUserRoleMonth:
                for camp in field:
        ...
        for value in db((db.auth_group.role!='Academic')&(db.auth_group.role!='DSI')).select():
            ...
            if str(request.vars['tipo'])=='all' or str(request.vars['tipo'])=='i':
                if session.search_grades_management == "" or session.search_grades_management is None:
                    ...
                    optionSearch.append(str(db((db.grades_log.project==project.name)&(db.grades_log.yearp==str(period.yearp))&(db.grades_log.period==str(T(period.period.name)))&(db.grades_log.date_log>=str(start))&(db.grades_log.date_log<str(end))&(db.grades_log.operation_log=='insert')&(db.grades_log.roll==value.role)&(db.grades_log.academic==str(session.search_grades_management))).count(db.grades_log.id)))
                pass
            if str(request.vars['tipo'])=='all' or str(request.vars['tipo'])=='u':
                if session.search_grades_management == "" or session.search_grades_management is None:
                    ...
                    optionSearch.append(str(db((db.grades_log.project==project.name)&(db.grades_log.yearp==str(period.yearp))&(db.grades_log.period==str(T(period.period.name)))&(db.grades_log.date_log>=str(start))&(db.grades_log.date_log<str(end))&(db.grades_log.operation_log=='update')&(db.grades_log.roll==value.role)&(db.grades_log.academic==str(session.search_grades_management))).count(db.grades_log.id)))
                pass
            if str(request.vars['tipo'])=='all' or str(request.vars['tipo'])=='d':
                if session.search_grades_management == "" or session.search_grades_management is None:
                    ...
                    optionSearch.append(str(db((db.grades_log.project==project.name)&(db.grades_log.yearp==str(period.yearp))&(db.grades_log.period==str(T(period.period.name)))&(db.grades_log.date_log>=str(start))&(db.grades_log.date_log<str(end))&(db.grades_log.operation_log=='delete')&(db.grades_log.roll==value.role)&(db.grades_log.academic==str(session.search_grades_management))).count(db.grades_log.id)))
                pass
        ...
        for value in tempUsers:
            ...
            if str(request.vars['tipo'])=='all' or str(request.vars['tipo'])=='i':
                if session.search_grades_management == "" or session.search_grades_management is None:
                    ...
                    optionSearch.append(str(db((db.grades_log.project==project.name)&(db.grades_log.yearp==str(period.yearp))&(db.grades_log.period==str(T(period.period.name)))&(db.grades_log.date_log>=str(start))&(db.grades_log.date_log<str(end))&(db.grades_log.operation_log=='insert')&(db.grades_log.roll==roll)&(db.grades_log.user_name==value)&(db.grades_log.academic==str(session.search_grades_management))).count(db.grades_log.id)))
                pass
            if str(request.vars['tipo'])=='all' or str(request.vars['tipo'])=='u':
                if session.search_grades_management == "" or session.search_grades_management is None:
                    ...
                    optionSearch.append(str(db((db.grades_log.project==project.name)&(db.grades_log.yearp==str(period.yearp))&(db.grades_log.period==str(T(period.period.name)))&(db.grades_log.date_log>=str(start))&(db.grades_log.date_log<str(end))&(db.grades_log.operation_log=='update')&(db.grades_log.roll==roll)&(db.grades_log.user_name==value)&(db.grades_log.academic==str(session.search_grades_management))).count(db.grades_log.id)))
                pass
            if str(request.vars['tipo'])=='all' or str(request.vars['tipo'])=='d':
                if session.search_grades_management == "" or session.search_grades_management is None:
                    ...
                    optionSearch.append(str(db((db.grades_log.project==project.name)&(db.grades_log.yearp==str(period.yearp))&(db.grades_log.period==str(T(period.period.name)))&(db.grades_log.date_log>=str(start))&(db.grades_log.date_log<str(end))&(db.grades_log.operation_log=='delete')&(db.grades_log.roll==roll)&(db.grades_log.user_name==value)&(db.grades_log.academic==str(session.search_grades_management))).count(db.grades_log.id)))
                pass
    ...
    if showLevel==True:
        ...
        if str(request.vars['tipo'])=='all' or str(request.vars['tipo'])=='i':
            if session.search_grades_management == "" or session.search_grades_management is None:
                ...
                vecAllUserRoleMonth.append(db((db.grades_log.project==project.name)&(db.grades_log.yearp==str(period.yearp))&(db.grades_log.period==str(T(period.period.name)))&(db.grades_log.date_log>=str(start))&(db.grades_log.date_log<str(end))&(db.grades_log.operation_log=='insert')&(db.grades_log.roll==roll)&(db.grades_log.user_name==userr)&(db.grades_log.academic==str(session.search_grades_management))).select())
            pass
        if str(request.vars['tipo'])=='all' or str(request.vars['tipo'])=='u':
            if session.search_grades_management == "" or session.search_grades_management is None:
                ...
                vecAllUserRoleMonth.append(db((db.grades_log.project==project.name)&(db.grades_log.yearp==str(period.yearp))&(db.grades_log.period==str(T(period.period.name)))&(db.grades_log.date_log>=str(start))&(db.grades_log.date_log<str(end))&(db.grades_log.operation_log=='update')&(db.grades_log.roll==roll)&(db.grades_log.user_name==userr)&(db.grades_log.academic==str(session.search_grades_management))).select())
            pass
        if str(request.vars['tipo'])=='all' or str(request.vars['tipo'])=='d':
            if session.search_grades_management == "" or session.search_grades_management is None:
                ...
                vecAllUserRoleMonth.append(db((db.grades_log.project==project.name)&(db.grades_log.yearp==str(period.yearp))&(db.grades_log.period==str(T(period.period.name)))&(db.grades_log.date_log>=str(start))&(db.grades_log.date_log<str(end))&(db.grades_log.operation_log=='delete')&(db.grades_log.roll==roll)&(db.grades_log.user_name==userr)&(db.grades_log.academic==str(session.search_grades_management))).select())
            pass
