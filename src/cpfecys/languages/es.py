...
"The Improve option allows the student to do a review of their report, if you want to use this feature you'll have to add a comment, so the student can know what to improve, the student will have a certain time to improve and  resend their report, you'll be notified via email when this happend.": "The Improve option allows the student to do a review of their report, if you want to use this feature you'll have to add a comment, so the student can know what to improve, the student will have a certain time to improve and  resend their report, you'll be notified via email when this happend.",
...
"This is a report preview, it can't be graded while the student works on it you'll be notified via mail when available to grade it": "This is a report preview, it can't be graded while the student works on it you'll be notified via mail when available to grade it",
...
'This report has been already graded max times, and resent to recheck, so this grading is final.': 'This report has been already graded max times, and resent to recheck, so this grading is final.',
