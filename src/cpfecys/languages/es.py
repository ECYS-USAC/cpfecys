...
'Alert': 'Alert',
'All fields are mandatory, please check and try again.': 'All fields are mandatory, please check and try again.',
...
'Description': 'Descripción',
'Description:': 'Descripción:',
'Desertion log': 'Desertion log',
'Desertion log added': 'Desertion log added',
'Desertion log deleted': 'Desertion log deleted',
'Desertion Log Updated': 'Desertion Log Updated',
'Desertion logs': 'Desertion logs',
'Desertion Report Type': 'Desertion Report Type',
'design': 'modificar',
'DESIGN': 'DISEÑO',
...
'Log Desertion': 'Log Desertion',
'Log Desertion Edit': 'Log Desertion Edit',
'Log Desertions': 'Log Desertions',
'Log entries': 'Entradas de Actividades',
'Log Inserted': 'Actividad Ingresada',
'Log Metrics': 'Registros con Métricas',
...
'merge': 'combinar',
'Metric': 'Metric',
'Metric Report Type': 'Metric Report Type',
...
'Operation not allowed 2.': 'Operation not allowed 2.',
...
'Password': 'Contraseña',
'Password (Leave the same for no                             change)': 'Password (Leave the same for no                             change)',
...
'Please verify all data is correct': 'Please verify all data is correct',
'Please verify all data is correct, Started = Gone + Continued': 'Please verify all data is correct, Started = Gone + Continued',
'Plugins': 'Plugins',
...
'Renew': 'Renovar',
'Repeat password (Leave the blank for                             no change)': 'Repeat password (Leave the blank for                             no change)',
...
'students gone': 'students gone',
'Students in Projects': 'Estudiantes en Proyectos',
'students started': 'students started',
...
'total': 'total',
'Total': 'Total',
'Total activity logs with metrics': 'Total activity logs with metrics',
'Total Anomalies': 'Total de Anomalias',
'Total Delivery': 'Total Entregados',
'Total desertion logs': 'Total desertion logs',
