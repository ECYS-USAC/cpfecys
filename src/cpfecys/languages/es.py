...
'Already existing users:': 'Already existing users:',
'And': 'Y',
...
'Assignation Date': 'Assignation Date',
'Assignation History': 'Assignation History',
'Assignation Length': 'Assignation Length',
'Assignation Start': 'Assignation Start',
...
'Back': 'Atras',
'Back to Assignation': 'Back to Assignation',
'Blank': 'Blanco',
...
"File doesn't seem properly encoded.": "File doesn't seem properly encoded.",
'File Item': 'File Item',
...
'Final Practice': 'Final Practice',
'Final Practice Admin': 'Final Practice Admin',
'Final Practice Assignation': 'Asignación de Práctica Final',
'Final Practice Record': 'Final Practice Record',
'Final Practice Student': 'Final Practice Student',
'First name': 'Nombre',
...
'From': 'From',
'Front notifications': 'Front notifications',
...
'not in': 'no esta en',
'Notification accesses': 'Notification accesses',
...
'Student must exist in UV database for assignation process to be correctly done.': 'Student must exist in UV database for assignation process to be correctly done.',
'Students': 'Students',
...
'User project items': 'User project items',
...
'User was already assigned, Ignoring.': 'User was already assigned, Ignoring.',
