...
'Aprobados': 'Aprobados',
'Aproved': 'Aproved',
'Aproved vrs. Failed Students': 'Aproved vrs. Failed Students',
'Aproved vrs. Gone Students': 'Aproved vrs. Gone Students',
...
'Continued': 'Continuaron',
'Continued vrs. Gone Students': 'Continued vrs. Gone Students',
...
'Current Report Dessertion': 'Current Report Dessertion',
...
'Desertion log updated': 'Desertion log updated',
...
'Item restriction exceptions': 'Item restriction exceptions',
...
'Please use only numeric values from zero to one hundred to score this report.': 'Please use only numeric values from zero to one hundred to score this report.',
...
"This operation can't be undone, do you want to continue?": "This operation can't be undone, do you want to continue?",
'Ticket': 'Tiquete',
...
'When a report es reproved or set to be improved, a comment giving more information is needed.': 'When a report es reproved or set to be improved, a comment giving more information is needed.',
